  ...
  return (
    <nav className={styles.navbar}>
      <div className={styles.container}>
        ...
        <button className={styles.menuToggle} onClick={toggleNav} aria-label="Toggle menu">
        ...
        <div className={`${styles.nav} ${navOpen ? styles.navOpen : ''}`}>
          ...
          <a href="#" className={styles.navLink} onClick={closeNav}>Plans</a>
          <a href="#" className={styles.navLink} onClick={closeNav}>About</a>
          <div className={styles.mobileActions}>
            <a href="#" className={styles.loginBtn} onClick={closeNav}>Log In</a>
